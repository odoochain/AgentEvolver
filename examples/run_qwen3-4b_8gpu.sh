...
python3 -m beyondagent.main_ppo \
    ...
    trainer.experiment_name='qwen3-4b_appworld_zyp' \
    trainer.nnodes=1 \
    trainer.save_freq=-1 \
    trainer.test_freq=20 \
    trainer.total_epochs=15 \
    trainer.val_before_train=True \
    trainer.validation_data_dir="experiments/exp_4B_${current_time}/validation_log" \
    trainer.rollout_data_dir="experiments/exp_4B_${current_time}/rollout_log" \
